...
public class AnimalMonitor 
{
    ...
    public void printSightingsOnCertainDay(int dayId)
    {
        for(Sighting record : sightings) {
    ...
    public void printSightingsOfAnimals(String animal)
    {
        sightings.stream()
            .map(sighting -> animal.equals(sighting.getAnimal()))
            .forEach(details -> System.out.println(details));
    }
    
    
    public long printNumSightingsBy(int spotterID)
    {
        long total;
  
        total =  sightings.stream()
